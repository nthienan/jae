...
setup(
    ...
    url='https://github.com/nthienan/jfrog-artifactory-exporter',
    author='An Nguyen',
    ...
    keywords='artifactory-exporter, artifactory, exporter, devops',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/nthienan/jfrog-artifactory-exporter/issues',
        'Source': 'https://github.com/nthienan/jfrog-artifactory-exporter',
    },
